        ...
        <section class="classes pt pb">
            <div class="classes__container">
                ...
                <div class="classes__buttons">
                    <button data-popup="#popup-request" type="button" class="classes__button btn btn_light">Записаться
                    </button>
                    <button data-popup="#popup-payment" type="button" class="classes__button btn btn_light btn_pay">
                        Оплатить
                    </button>
                </div>
            </div>
